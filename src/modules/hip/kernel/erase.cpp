...
template RppStatus hip_exec_erase_tensor<Rpp8u>(Rpp8u*,
                                                RpptDescPtr,
                                                Rpp8u*,
                                                RpptDescPtr,
                                                RpptRoiLtrb*,
                                                ...
                                                RpptRoiType,
                                                rpp::Handle&);
template RppStatus hip_exec_erase_tensor<half>(half*,
                                               RpptDescPtr,
                                               half*,
                                               RpptDescPtr,
                                               RpptRoiLtrb*,
                                               ...
                                               RpptRoiType,
                                               rpp::Handle&);
template RppStatus hip_exec_erase_tensor<Rpp32f>(Rpp32f*,
                                                 RpptDescPtr,
                                                 Rpp32f*,
                                                 RpptDescPtr,
                                                 RpptRoiLtrb*,
                                                 ...
                                                 RpptRoiType,
                                                 rpp::Handle&);
template RppStatus hip_exec_erase_tensor<Rpp8s>(Rpp8s*,
                                                RpptDescPtr,
                                                Rpp8s*,
                                                RpptDescPtr,
                                                RpptRoiLtrb*,
