...
__device__ void sobel_filter_7x7_bidirectional_row_hip_compute(uchar *srcPtr, d_float8 *dst_f8x, d_float8 *dst_f8y, float *filterX, float *filterY)
{
    float src_f1;
    uint4 src_ui4 = *(reinterpret_cast<uint4 *>(srcPtr));
    src_f1 = rpp_hip_unpack0(src_ui4.x);
    ...
    dst_f8y->f1[4] = fmaf(src_f1, filterY[0], dst_f8y->f1[4]);
    src_f1 = rpp_hip_unpack1(src_ui4.y);
    dst_f8x->f1[0] = fmaf(src_f1, filterX[5], dst_f8x->f1[0]);
    dst_f8x->f1[1] = fmaf(src_f1, filterX[4], dst_f8x->f1[1]);
    dst_f8x->f1[2] = fmaf(src_f1, filterX[3], dst_f8x->f1[2]);
    dst_f8x->f1[3] = fmaf(src_f1, filterX[2], dst_f8x->f1[3]);
    dst_f8x->f1[4] = fmaf(src_f1, filterX[1], dst_f8x->f1[4]);
    dst_f8x->f1[5] = fmaf(src_f1, filterX[0], dst_f8x->f1[5]);
    dst_f8y->f1[0] = fmaf(src_f1, filterY[5], dst_f8y->f1[0]);
    dst_f8y->f1[1] = fmaf(src_f1, filterY[4], dst_f8y->f1[1]);
    dst_f8y->f1[2] = fmaf(src_f1, filterY[3], dst_f8y->f1[2]);
    dst_f8y->f1[3] = fmaf(src_f1, filterY[2], dst_f8y->f1[3]);
    dst_f8y->f1[4] = fmaf(src_f1, filterY[1], dst_f8y->f1[4]);
    dst_f8y->f1[5] = fmaf(src_f1, filterY[0], dst_f8y->f1[5]);
    src_f1 = rpp_hip_unpack2(src_ui4.y);
    dst_f8x->f1[0] = fmaf(src_f1, filterX[6], dst_f8x->f1[0]);
    dst_f8x->f1[1] = fmaf(src_f1, filterX[5], dst_f8x->f1[1]);
    dst_f8x->f1[2] = fmaf(src_f1, filterX[4], dst_f8x->f1[2]);
    dst_f8x->f1[3] = fmaf(src_f1, filterX[3], dst_f8x->f1[3]);
    dst_f8x->f1[4] = fmaf(src_f1, filterX[2], dst_f8x->f1[4]);
    dst_f8x->f1[5] = fmaf(src_f1, filterX[1], dst_f8x->f1[5]);
    dst_f8x->f1[6] = fmaf(src_f1, filterX[0], dst_f8x->f1[6]);
    dst_f8y->f1[0] = fmaf(src_f1, filterY[6], dst_f8y->f1[0]);
    dst_f8y->f1[1] = fmaf(src_f1, filterY[5], dst_f8y->f1[1]);
    dst_f8y->f1[2] = fmaf(src_f1, filterY[4], dst_f8y->f1[2]);
    dst_f8y->f1[3] = fmaf(src_f1, filterY[3], dst_f8y->f1[3]);
    dst_f8y->f1[4] = fmaf(src_f1, filterY[2], dst_f8y->f1[4]);
    dst_f8y->f1[5] = fmaf(src_f1, filterY[1], dst_f8y->f1[5]);
    dst_f8y->f1[6] = fmaf(src_f1, filterY[0], dst_f8y->f1[6]);
    src_f1 = rpp_hip_unpack3(src_ui4.y);
    dst_f8x->f1[1] = fmaf(src_f1, filterX[6], dst_f8x->f1[1]);
    dst_f8x->f1[2] = fmaf(src_f1, filterX[5], dst_f8x->f1[2]);
    dst_f8x->f1[3] = fmaf(src_f1, filterX[4], dst_f8x->f1[3]);
    dst_f8x->f1[4] = fmaf(src_f1, filterX[3], dst_f8x->f1[4]);
    dst_f8x->f1[5] = fmaf(src_f1, filterX[2], dst_f8x->f1[5]);
    dst_f8x->f1[6] = fmaf(src_f1, filterX[1], dst_f8x->f1[6]);
    dst_f8x->f1[7] = fmaf(src_f1, filterX[0], dst_f8x->f1[7]);
    dst_f8y->f1[1] = fmaf(src_f1, filterY[6], dst_f8y->f1[1]);
    dst_f8y->f1[2] = fmaf(src_f1, filterY[5], dst_f8y->f1[2]);
    dst_f8y->f1[3] = fmaf(src_f1, filterY[4], dst_f8y->f1[3]);
    dst_f8y->f1[4] = fmaf(src_f1, filterY[3], dst_f8y->f1[4]);
    dst_f8y->f1[5] = fmaf(src_f1, filterY[2], dst_f8y->f1[5]);
    dst_f8y->f1[6] = fmaf(src_f1, filterY[1], dst_f8y->f1[6]);
    dst_f8y->f1[7] = fmaf(src_f1, filterY[0], dst_f8y->f1[7]);
    src_f1 = rpp_hip_unpack0(src_ui4.z);
    dst_f8x->f1[2] = fmaf(src_f1, filterX[6], dst_f8x->f1[2]);
    dst_f8x->f1[3] = fmaf(src_f1, filterX[5], dst_f8x->f1[3]);
    dst_f8x->f1[4] = fmaf(src_f1, filterX[4], dst_f8x->f1[4]);
    dst_f8x->f1[5] = fmaf(src_f1, filterX[3], dst_f8x->f1[5]);
    dst_f8x->f1[6] = fmaf(src_f1, filterX[2], dst_f8x->f1[6]);
    dst_f8x->f1[7] = fmaf(src_f1, filterX[1], dst_f8x->f1[7]);
    dst_f8y->f1[2] = fmaf(src_f1, filterY[6], dst_f8y->f1[2]);
    dst_f8y->f1[3] = fmaf(src_f1, filterY[5], dst_f8y->f1[3]);
    dst_f8y->f1[4] = fmaf(src_f1, filterY[4], dst_f8y->f1[4]);
    dst_f8y->f1[5] = fmaf(src_f1, filterY[3], dst_f8y->f1[5]);
    dst_f8y->f1[6] = fmaf(src_f1, filterY[2], dst_f8y->f1[6]);
    dst_f8y->f1[7] = fmaf(src_f1, filterY[1], dst_f8y->f1[7]);
    src_f1 = rpp_hip_unpack1(src_ui4.z);
    dst_f8x->f1[3] = fmaf(src_f1, filterX[6], dst_f8x->f1[3]);
    dst_f8x->f1[4] = fmaf(src_f1, filterX[5], dst_f8x->f1[4]);
    dst_f8x->f1[5] = fmaf(src_f1, filterX[4], dst_f8x->f1[5]);
    dst_f8x->f1[6] = fmaf(src_f1, filterX[3], dst_f8x->f1[6]);
    dst_f8x->f1[7] = fmaf(src_f1, filterX[2], dst_f8x->f1[7]);
    dst_f8y->f1[3] = fmaf(src_f1, filterY[6], dst_f8y->f1[3]);
    dst_f8y->f1[4] = fmaf(src_f1, filterY[5], dst_f8y->f1[4]);
    dst_f8y->f1[5] = fmaf(src_f1, filterY[4], dst_f8y->f1[5]);
    dst_f8y->f1[6] = fmaf(src_f1, filterY[3], dst_f8y->f1[6]);
    dst_f8y->f1[7] = fmaf(src_f1, filterY[2], dst_f8y->f1[7]);
    src_f1 = rpp_hip_unpack2(src_ui4.z);
    dst_f8x->f1[4] = fmaf(src_f1, filterX[6], dst_f8x->f1[4]);
    dst_f8x->f1[5] = fmaf(src_f1, filterX[5], dst_f8x->f1[5]);
    dst_f8x->f1[6] = fmaf(src_f1, filterX[4], dst_f8x->f1[6]);
    dst_f8x->f1[7] = fmaf(src_f1, filterX[3], dst_f8x->f1[7]);
    dst_f8y->f1[4] = fmaf(src_f1, filterY[6], dst_f8y->f1[4]);
    dst_f8y->f1[5] = fmaf(src_f1, filterY[5], dst_f8y->f1[5]);
    dst_f8y->f1[6] = fmaf(src_f1, filterY[4], dst_f8y->f1[6]);
    dst_f8y->f1[7] = fmaf(src_f1, filterY[3], dst_f8y->f1[7]);
    src_f1 = rpp_hip_unpack3(src_ui4.z);
    dst_f8x->f1[5] = fmaf(src_f1, filterX[6], dst_f8x->f1[5]);
    dst_f8x->f1[6] = fmaf(src_f1, filterX[5], dst_f8x->f1[6]);
    dst_f8x->f1[7] = fmaf(src_f1, filterX[4], dst_f8x->f1[7]);
    dst_f8y->f1[5] = fmaf(src_f1, filterY[6], dst_f8y->f1[5]);
    dst_f8y->f1[6] = fmaf(src_f1, filterY[5], dst_f8y->f1[6]);
    dst_f8y->f1[7] = fmaf(src_f1, filterY[4], dst_f8y->f1[7]);
    src_f1 = rpp_hip_unpack0(src_ui4.w);
    dst_f8x->f1[6] = fmaf(src_f1, filterX[6], dst_f8x->f1[6]);
    dst_f8x->f1[7] = fmaf(src_f1, filterX[5], dst_f8x->f1[7]);
    dst_f8y->f1[6] = fmaf(src_f1, filterY[6], dst_f8y->f1[6]);
    dst_f8y->f1[7] = fmaf(src_f1, filterY[5], dst_f8y->f1[7]);
    src_f1 = rpp_hip_unpack1(src_ui4.w);
    dst_f8x->f1[7] = fmaf(src_f1, filterX[6], dst_f8x->f1[7]);
    dst_f8y->f1[7] = fmaf(src_f1, filterY[6], dst_f8y->f1[7]);
}
                                                        ...
                                                        RpptROIPtr roiTensorPtrSrc)
{
    ...
    if ((id_x_o < roiTensorPtrSrc[id_z].xywhROI.roiWidth) &&
        ...
        (hipThreadIdx_y < tileSize.y))
    {
        sobel_filter_7x7_bidirectional_row_hip_compute(&src_smem[hipThreadIdx_y    ][hipThreadIdx_x8], &sum_f8x, &sum_f8y, filterRowX1, filterRowY1);
        sobel_filter_7x7_bidirectional_row_hip_compute(&src_smem[hipThreadIdx_y + 1][hipThreadIdx_x8], &sum_f8x, &sum_f8y, filterRowX2, filterRowY2);
        sobel_filter_7x7_bidirectional_row_hip_compute(&src_smem[hipThreadIdx_y + 2][hipThreadIdx_x8], &sum_f8x, &sum_f8y, filterRowX3, filterRowY3);
        sobel_filter_7x7_bidirectional_row_hip_compute(&src_smem[hipThreadIdx_y + 3][hipThreadIdx_x8], &sum_f8x, &sum_f8y, filterRowX4, filterRowY4);
        sobel_filter_7x7_bidirectional_row_hip_compute(&src_smem[hipThreadIdx_y + 4][hipThreadIdx_x8], &sum_f8x, &sum_f8y, filterRowX5, filterRowY5);
        sobel_filter_7x7_bidirectional_row_hip_compute(&src_smem[hipThreadIdx_y + 5][hipThreadIdx_x8], &sum_f8x, &sum_f8y, filterRowX6, filterRowY6);
        sobel_filter_7x7_bidirectional_row_hip_compute(&src_smem[hipThreadIdx_y + 6][hipThreadIdx_x8], &sum_f8x, &sum_f8y, filterRowX7, filterRowY7);
        rpp_hip_pixel_check_0to255(&sum_f8x);
        rpp_hip_pixel_check_0to255(&sum_f8y);
        rpp_hip_adjust_range(dstPtr, &sum_f8x);
        rpp_hip_adjust_range(dstPtr, &sum_f8y);
...
template <typename T>
__global__ void sobel_filter_7x7_pln_unidirection_tensor(T *srcPtr,
                                               uint3 srcStridesNCH,
                                               T *dstPtr,
                                               uint3 dstStridesNCH,
                                               int channelsDst,
                                               ...
                                               int sobelType)
{
    ...
    int srcIdx = (id_z * srcStridesNCH.x) + ((id_y_i + roiTensorPtrSrc[id_z].xywhROI.xy.y) * srcStridesNCH.z) + (id_x_i + roiTensorPtrSrc[id_z].xywhROI.xy.x);
    int dstIdx = (id_z * dstStridesNCH.x) + (id_y_o * dstStridesNCH.z) + id_x_o;
    float *filter_row1 = (!sobelType) ? sobel7x7XHip : sobel7x7YHip;
                                          ...
                                          rpp::Handle& handle)
{
    ...
    else if (kernelSize == 7)
    {
        ...
        {
            hipLaunchKernelGGL(sobel_filter_7x7_pln_unidirection_tensor,
                               dim3(ceil((float)globalThreads_x/tileSize.x), ceil((float)globalThreads_y/tileSize.y), ceil((float)globalThreads_z/LOCAL_THREADS_Z)),
                               dim3(LOCAL_THREADS_X, LOCAL_THREADS_Y, LOCAL_THREADS_Z),
                               0,
                               handle.GetStream(),
