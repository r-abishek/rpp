...
template <typename T>
__global__ void tensor_mul_tensor_1d_hip_tensor(T *srcPtr1,
                                                T *srcPtr2,
                                                uint srcStrides1,
                                                uint srcStrides2,
                                                uint *srcDims1,
                                                ...
                                                uint *src2RoiTensor)
{
    ...
    rpp_hip_math_multiply8(&src1_f8, &src2_f8, &dst_f8);
    rpp_hip_pack_float8_and_store8(dstPtr + dstIdx, &dst_f8);
}

template <typename T>
__global__ void tensor_mul_tensor_2d_hip_tensor(T *srcPtr1,
                                                T *srcPtr2,
                                                uint2 srcStrides1NH,
                                                uint2 srcStrides2NH,
                                                uint *srcDims1,
...
template <typename T>
__global__ void tensor_mul_tensor_3d_hip_tensor(T *srcPtr1,
                                                T *srcPtr2,
                                                uint2 srcStrides1DH,
                                                uint2 srcStrides2DH,
                                                uint *srcDims1,
...
template <typename T>
__global__ void tensor_mul_tensor_nd_hip_tensor(T *srcPtr1,
                                                T *srcPtr2,
                                                uint *srcStrides1,
                                                uint *srcStrides2,
                                                uint *srcDims1,
...
template <typename T>
RppStatus hip_exec_tensor_mul_tensor_generic_tensor(T *srcPtr1,
                                                    T *srcPtr2,
                                                    ...
                                                    rpp::Handle& handle)
{
    ...
    if (numDims == 1)
    {
        ...
        hipLaunchKernelGGL(tensor_mul_tensor_1d_hip_tensor,
    ...
    else if (numDims == 2)
    {
        ...
        hipLaunchKernelGGL(tensor_mul_tensor_2d_hip_tensor,
                           dim3(ceil((float)globalThreads_x/LOCAL_THREADS_X), ceil((float)globalThreads_y/LOCAL_THREADS_Y), ceil((float)globalThreads_z/LOCAL_THREADS_Z)),
                           dim3(LOCAL_THREADS_X, LOCAL_THREADS_Y, LOCAL_THREADS_Z),
                           0,
                           handle.GetStream(),
    ...
    else if (numDims == 3)
    {
        ...
        {
            hipLaunchKernelGGL(tensor_mul_tensor_3d_hip_tensor,
                               dim3(ceil((float)globalThreads_x/LOCAL_THREADS_X), ceil((float)globalThreads_y/LOCAL_THREADS_Y), ceil((float)globalThreads_z/LOCAL_THREADS_Z)),
                               dim3(LOCAL_THREADS_X, LOCAL_THREADS_Y, LOCAL_THREADS_Z),
                               0,
                               handle.GetStream(),
    ...
    else
    {
        ...
        hipLaunchKernelGGL(tensor_mul_tensor_nd_hip_tensor,
...
template RppStatus hip_exec_tensor_mul_tensor_generic_tensor<Rpp8u>(Rpp8u*,
                                                                    Rpp8u*,
                                                                    RpptGenericDescPtr,
                                                                    RpptGenericDescPtr,
                                                                    Rpp8u*,
...
template RppStatus hip_exec_tensor_mul_tensor_generic_tensor<Rpp32f>(Rpp32f*,
                                                                     Rpp32f*,
                                                                     RpptGenericDescPtr,
                                                                     RpptGenericDescPtr,
                                                                     Rpp32f*,
...
template RppStatus hip_exec_tensor_mul_tensor_generic_tensor<half>(half*,
                                                                   half*,
                                                                   RpptGenericDescPtr,
                                                                   RpptGenericDescPtr,
                                                                   half*,
...
template RppStatus hip_exec_tensor_mul_tensor_generic_tensor<Rpp8s>(Rpp8s*,
                                                                    Rpp8s*,
                                                                    RpptGenericDescPtr,
                                                                    RpptGenericDescPtr,
                                                                    Rpp8s*,
